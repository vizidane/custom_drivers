...
int pcd_platform_driver_probe(struct platform_device *pdev)
{
	...
	*/
	...
	pr_info("device id = %s, config1 = %d, config2 = %d \n",pdev->id_entry->name, pcdev_config[pdev->id_entry->driver_data].config_item1,pcdev_config[pdev->id_entry->driver_data].config_item2);
